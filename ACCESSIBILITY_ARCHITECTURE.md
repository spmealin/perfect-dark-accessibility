...
shield consoles, and the Skedar Ruins final-boss spikes. Registry identity follows
the engine's current tag-to-object mapping rather than asking an object for one tag.
