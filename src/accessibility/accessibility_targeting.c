...
#define ACCESSIBILITY_TARGETING_COMBAT_FULL_DISTANCE 600.0f
#define ACCESSIBILITY_TARGETING_COMBAT_FADE_DISTANCE 3500.0f
#define ACCESSIBILITY_TARGETING_COMBAT_SILENT_DISTANCE 4000.0f
...
static const struct accessibilitytargetingpolicy g_AccessibilityTargetingRangePolicy = {
	...
	ACCESSIBILITY_TARGETING_COMBAT_FULL_DISTANCE,
	ACCESSIBILITY_TARGETING_COMBAT_FADE_DISTANCE,
	ACCESSIBILITY_TARGETING_COMBAT_SILENT_DISTANCE,
};
